...
intersectionConfig      =     struct(...
    ...
    ,'crossingSpeed',repmat(round([30 40 30]*5280/3600,simParameters.speedDecimals),6,1)... % COMPATIBLE TO DESTINATION VECTOR
    ,'Y', 3 ...
    ,'AR',3 ...
    ,'phaseSet',[1,2,3,4]... % LIMIT THE PHASES TO THE LIMITED SET THAT COVERS ALL MOVEMENTS
